...
<div class="login-box bg-white box-shadow border-radius-10">
  <div class="login-title">
      <h2 class="text-center text-primary">Ingresar a la plataforma </h2>
  </div>
  <form action="{{ route('tienda.login-handler') }}" method="POST">
     @csrf
     <x-alert.form-alert/>
      ...
      <div class="row pb-30">
          ...
          <div class="col-6">
              <div class="forgot-password">
                  <a href="{{ route('tienda.password.request') }}">¿Olvidaste tu contraseña?</a>
              </div>
          </div>
      </div>
      <div class="row">
