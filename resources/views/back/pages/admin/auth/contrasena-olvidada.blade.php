...
@section('PageTitle',isset($pageTitle)? $pageTitle : 'Agro MarketPlace - ¿Olvidaste tu contraseña?')
@section('content')
<div class="login-box bg-white box-shadow border-radius-10">
							...
							<form action="{{route('admin.send-password-reset-link')}}" method="POST">
								...
								<div class="input-group custom">
									<input type="text" class="form-control form-control-lg" placeholder="Correo electrónico" name="email"
									value="{{old('email')}}">
								...
								<div class="row align-items-center">
									...
									<div class="col-5">
										<div class="input-group mb-0">
											<a class="btn btn-outline-primary btn-lg btn-block" href="{{route('admin.login')}}">Ingresar</a>
										</div>
									</div>
								</div>
							</form>
