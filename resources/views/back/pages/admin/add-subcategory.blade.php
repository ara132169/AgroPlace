...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Añadir subcategorias')
@section('content')
  <div class="row">
    <div class="col-md-12">
        <div class="pd-20 card-box mb-30">
            <div class="clearfix">
                <div class="pull-left">
                    <h4 class="text-dark">Añadir SubCategoria</h4>
                </div>
                <div class="pull-right">
                    <a href="{{ route('admin.manage-categories.cats-subcats-list') }}" class="btn btn-primary btn-sm">
                     <i class="ion-arrow-left-a"></i> Regresar a la lista de categorias
                    </a>
                </div>
            </div>
            <hr>
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="subcategory_name" placeholder="Ingresa el nombre" value="{{ old('subcategory_name') }}">
                ...
                <div class="col-md-7">
                    <div class="form-group">
                        <label for="">Categoría hijo de</label>
