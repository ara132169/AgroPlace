            ...
            <div class="clearfix">
                ...
                <div class="pull-right">
                    <a href="{{ route('admin.manage-categories.cats-subcats-list') }}" class="btn btn-primary btn-sm">
                     <i class="ion-arrow-left-a"></i> Regresar a lista de categorías
                    </a>
                </div>
            </div>
            <hr>
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="category_name" placeholder="Ingresa el nombre" value="{{ $category->category_name }}">
                        @error('category_name')
