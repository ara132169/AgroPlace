...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Productos - Subcategoría')
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="alert alert-info text-center">
                            ...
                            <a href="{{ route('categoria.productos', $categoria->category_slug) }}" class="btn btn-primary btn-rounded">
                                Ver todos los productos de {{ $categoria->category_name }}
                            </a>
                        </div>
                    </div>
                </div>
