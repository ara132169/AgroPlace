...
@section('pageTitle')
{{ $subsubcategoria->subcategory_name ?? 'Productos' }}
@endsection
                            ...
                            <div class="sticky-sidebar">
                                ...
                                <div class="widget widget-collapsible">
                                    ...
                                    <ul class="widget-body filter-items search-ul">
                                        ...
                                        <li>
                                            <a href="{{ route('subcategoria', ['categorySlug' => $categoria->category_slug, 'subcategorySlug' => $subcategoria->subcategory_slug]) }}">
                                                {{ $subcategoria->subcategory_name }}
                                            </a>
                                            @if($subcategoria->children && $subcategoria->children->count() > 0)
                                                <ul class="ml-4">
                                                    @foreach($subcategoria->children as $child)
                                                        <li class="{{ $child->id == $subsubcategoria->id ? 'active' : '' }}">
                                                            <a href="{{ route('subsubcategoria', ['categorySlug' => $categoria->category_slug, 'subcategorySlug' => $subcategoria->subcategory_slug, 'subsubcategorySlug' => $child->subcategory_slug]) }}">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="alert alert-info text-center" style="padding: 3rem;">
                            ...
                            <p>Actualmente no hay productos en "{{ $subsubcategoria->subcategory_name }}".</p>
                            <a href="{{ route('subcategoria', ['categorySlug' => $categoria->category_slug, 'subcategorySlug' => $subcategoria->subcategory_slug]) }}" class="btn btn-primary btn-rounded mt-3">
                                <i class="w-icon-angle-left"></i> Ver todos los productos de {{ $subcategoria->subcategory_name }}
                            </a>
                        </div>
                    </div>
                </div>
